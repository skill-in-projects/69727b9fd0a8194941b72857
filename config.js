...
const CONFIG = {
    API_URL: "https://webapi69727b9fd0a8194941b72857-production.up.railway.app"
};
...
(function() {
    ...
    function getBoardId() {
        ...
        console.warn('Mentor tracking: CONFIG.API_URL not availaxxble or does not contain valid boardId pattern');
        return null;
    }
